# /task-review-adversarial-general Command

When this command is used, execute the following task:

## Review Adversarial General Task
...
This command executes the Review Adversarial General task from the BMAD CORE module.
