        ...
        shell: {
            ...
            myAppsDetailPage: {
                ...
                accessPanel: {
                    ...
                    forceHttpsLabel: 'HTTPS policy',
                    forceHttpsSwitch: 'Force HTTPS redirect',
                    forceHttpsHelper: 'Redirect HTTP requests to HTTPS after a certificate is bound or requested.',
                    forceHttpsEnabled: 'Force HTTPS',
                    forceHttpsRequiresCertificate: 'Force HTTPS requires an existing certificate or a new certificate request.',
        ...
        shell: {
            ...
            myAppsDetailPage: {
                ...
                accessPanel: {
                    ...
                    forceHttpsLabel: '强制HTTPS',
                    forceHttpsSwitch: '强制HTTPS',
                    forceHttpsHelper: '',
                    forceHttpsEnabled: '强制HTTPS',
                    forceHttpsRequiresCertificate: '强制 HTTPS 需要先选择已有证书，或申请新的 SSL 证书。',
                    save: '保存访问配置',
                    saveShort: '保存',
