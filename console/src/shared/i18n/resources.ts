    ...
    en: {
        shell: {
            ...
            applicationsHubPage: {
                hero: {
                    title: 'Applications',
                    description: 'Manage installed apps, browse the store, and deploy from Docker Compose.',
                },
                menu: {
                    action: 'Deploy App',
                    title: 'Deployment method',
                    marketplace: 'App Store',
                    customInstall: 'Compose Deploy',
                },
                cards: {
                    deploy: {
                        title: 'Applications',
    ...
    'zh-CN': {
        shell: {
            ...
            applicationsHubPage: {
                hero: {
                    title: '应用',
                    description: '集中管理已安装应用、应用商店和 Docker Compose 部署。',
                },
                menu: {
                    action: '部署应用',
                    title: '部署方式',
                    marketplace: '应用商店',
                    customInstall: 'Compose部署',
                },
                cards: {
                    deploy: {
                        title: '应用',
