# brainstorm-game Workflow Rule

This rule defines the brainstorm-game workflow.
...
Reference this workflow with `@workflow-brainstorm-game` to execute the guided workflow.
