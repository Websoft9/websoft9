# create-excalidraw-diagram Workflow Rule

This rule defines the create-excalidraw-diagram workflow.
...
Reference this workflow with `@workflow-create-excalidraw-diagram` to execute the guided workflow.
