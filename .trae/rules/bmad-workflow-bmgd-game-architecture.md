# game-architecture Workflow Rule

This rule defines the game-architecture workflow.
...
Reference this workflow with `@workflow-game-architecture` to execute the guided workflow.

## Module

Part of the BMAD BMGD module.
