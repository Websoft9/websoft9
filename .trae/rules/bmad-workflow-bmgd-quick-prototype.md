# quick-prototype Workflow Rule

This rule defines the quick-prototype workflow.
...
Reference this workflow with `@workflow-quick-prototype` to execute the guided workflow.
