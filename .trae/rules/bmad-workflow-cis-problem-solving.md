# problem-solving Workflow Rule

This rule defines the problem-solving workflow.
...
Reference this workflow with `@workflow-problem-solving` to execute the guided workflow.
