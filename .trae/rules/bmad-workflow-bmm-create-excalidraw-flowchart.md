# create-excalidraw-flowchart Workflow Rule

This rule defines the create-excalidraw-flowchart workflow.
...
Reference this workflow with `@workflow-create-excalidraw-flowchart` to execute the guided workflow.
