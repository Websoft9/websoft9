# create-excalidraw-dataflow Workflow Rule

This rule defines the create-excalidraw-dataflow workflow.
...
Reference this workflow with `@workflow-create-excalidraw-dataflow` to execute the guided workflow.
