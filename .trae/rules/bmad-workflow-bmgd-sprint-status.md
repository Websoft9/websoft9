# sprint-status Workflow Rule

This rule defines the sprint-status workflow.
...
Reference this workflow with `@workflow-sprint-status` to execute the guided workflow.
