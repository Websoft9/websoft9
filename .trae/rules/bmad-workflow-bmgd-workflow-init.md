# workflow-init Workflow Rule

This rule defines the workflow-init workflow.
...
Reference this workflow with `@workflow-workflow-init` to execute the guided workflow.
