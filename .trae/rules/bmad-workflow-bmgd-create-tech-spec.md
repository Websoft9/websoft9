# create-tech-spec Workflow Rule

This rule defines the create-tech-spec workflow.
...
Reference this workflow with `@workflow-create-tech-spec` to execute the guided workflow.
