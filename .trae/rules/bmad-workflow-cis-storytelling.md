# storytelling Workflow Rule

This rule defines the storytelling workflow.
...
Reference this workflow with `@workflow-storytelling` to execute the guided workflow.
