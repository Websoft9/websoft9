# design-thinking Workflow Rule

This rule defines the design-thinking workflow.
...
Reference this workflow with `@workflow-design-thinking` to execute the guided workflow.
