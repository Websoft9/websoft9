# create-excalidraw-wireframe Workflow Rule

This rule defines the create-excalidraw-wireframe workflow.
...
Reference this workflow with `@workflow-create-excalidraw-wireframe` to execute the guided workflow.
