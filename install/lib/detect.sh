...
_detect_modern_data_root() {
  local data_root
  data_root="$(resolve_existing_runtime_data_root "$DEFAULT_INSTALL_PATH")"
...
detect_print_signals() {
  ...
  log_info "Modern data root configured: $(resolve_existing_runtime_data_root "$DEFAULT_INSTALL_PATH")"
